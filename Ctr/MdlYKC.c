...
typedef enum {
	...
	/* 探索边沿，边沿传感器需要被不断触发 */
	CLN_ST_EXP_FORWARD_L	= 8,		/* 前进探索左边沿 */
	CLN_ST_EXP_FORWARD_R	= 9,		/* 前进探索右边沿 */
	CLN_ST_EXP_BACK_L		= 10,		/* 后退探索左边沿 */
	CLN_ST_EXP_BACK_R		= 11,		/* 后退探索右边沿 */
	CLN_ST_BLANK			= 12,		/* 空白 */
...
const CLN_ST_SEQ cnst_ClnSTSeq[] = {
	...
	{CLN_ST_CTURN, 			90, 	-4000,					SPRAY_INSTR_SPRAY_NONE},	/* 12. 后退S弯:减少角度 */
	{CLN_ST_DRIVE, 			90, 	FORWORD_INSTR_nINF,		SPRAY_INSTR_SPRAY_BACK},	/* 13. 后退到头 */
	{CLN_ST_CTURN, 			120, 	4000,					SPRAY_INSTR_SPRAY_NONE},	/* 14. 前进S弯:加大角度 */
	{CLN_ST_CTURN, 			90, 	4000,					SPRAY_INSTR_SPRAY_NONE},	/* 15. 前进S弯:减少角度 */
	{CLN_ST_DRIVE, 			90, 	FORWORD_INSTR_INF,		SPRAY_INSTR_SPRAY_FRONT},	/* 16. 前进到头 */
	{CLN_ST_CTURN, 			60, 	-4000,					SPRAY_INSTR_SPRAY_NONE},	/* 17. 后退S弯:加大角度 */
	{CLN_ST_CTURN, 			90, 	-4000,					SPRAY_INSTR_SPRAY_NONE},	/* 18. 前进S弯:减少角度 */
	{CLN_ST_JUMP, 			0, 		-6,						SPRAY_INSTR_SPRAY_NONE},	/* 19. 跳转到Z清洁开头 */


	/* 底部清洁:自右向左(前进)S弯碰边后：先前进，再后退 */
	{CLN_ST_JTURN, 			90, 	1,						SPRAY_INSTR_SPRAY_NONE},	/* 20. 前进J弯:减少角度 */
	{CLN_ST_EXP_FORWARD_L, 	90, 	FORWORD_INSTR_INF,		SPRAY_INSTR_SPRAY_FRONT},	/* 21. 前进靠左上角 */
	{CLN_ST_EXP_BACK_L, 	90, 	FORWORD_INSTR_nINF,		SPRAY_INSTR_SPRAY_NONE},	/* 22. 沿着上沿后退 */
	{CLN_ST_JTURN, 			60, 	1,						SPRAY_INSTR_SPRAY_NONE},	/* 23. 前进J弯:加大角度 */
	{CLN_ST_DRIVE, 			90, 	4000,					SPRAY_INSTR_SPRAY_NONE},	/* 24. 前进J弯:减少角度 */
	{CLN_ST_DRIVE, 			90, 	FORWORD_INSTR_ReturnX,	SPRAY_INSTR_SPRAY_NONE},	/* 25. X轴返回原点 */
	{CLN_ST_DRIVE,	 		0, 		0,						SPRAY_INSTR_SPRAY_NONE},	/* 26. 旋转到朝上 */
	{CLN_ST_DRIVE, 			0, 		FORWORD_INSTR_ReturnY,	SPRAY_INSTR_SPRAY_NONE},	/* 27. Y轴返回原点 */
	{CLN_ST_END, 			0, 		0,						SPRAY_INSTR_SPRAY_NONE},	/* 28. 结束清洁 */

	/* 底部清洁:自左向右(后退)S弯碰边后：先后退，再前进 */
	{CLN_ST_JTURN, 			90,	 	-1, 					SPRAY_INSTR_SPRAY_NONE},	/* 29. 后退J弯:减少角度 */
	{CLN_ST_EXP_BACK_L, 	90, 	FORWORD_INSTR_nINF, 	SPRAY_INSTR_SPRAY_BACK},	/* 30. 沿着下沿后退 */
	{CLN_ST_EXP_FORWARD_L, 	90, 	FORWORD_INSTR_INF, 		SPRAY_INSTR_SPRAY_NONE},	/* 31. 沿着下沿前进 */
	{CLN_ST_JTURN, 			120, 	-1, 					SPRAY_INSTR_SPRAY_NONE},	/* 32. 后退J弯:加大角度 */
	{CLN_ST_DRIVE, 			90, 	-4000, 					SPRAY_INSTR_SPRAY_NONE},	/* 33. 后退S弯:减少角度 */
	{CLN_ST_DRIVE, 			90, 	FORWORD_INSTR_ReturnX, 	SPRAY_INSTR_SPRAY_NONE},	/* 34. X轴返回原点 */
	{CLN_ST_DRIVE, 			0, 		0, 						SPRAY_INSTR_SPRAY_NONE},	/* 35. 旋转到朝上 */
	{CLN_ST_DRIVE, 			0, 		FORWORD_INSTR_ReturnY, 	SPRAY_INSTR_SPRAY_NONE},	/* 36. Y轴返回原点 */
	{CLN_ST_END, 			0, 		0, 						SPRAY_INSTR_SPRAY_NONE},	/* 37. 结束清洁 */
...
#define CLN_SEQ_WIN_BTM_R2L_No	20			/* 底部清洁，自右向左 */
#define CLN_SEQ_WIN_BTM_L2R_No	29			/* 底部清洁，自左向右 */
...
typedef struct {
	...
	int32 i32Y;			
	float32 fAngle;		/* 机器人朝向，12点方向为0度（0°为0点，-45°为9点，+45°为3点） */
	...
	float32 fAimedAngle;				/* 头部的目标绝对角度（0°为0点，-45°为9点，+45°为3点） */
...
#define PUMP_IDEL_DUTY				0.3f		/* IDEL时维持很低的吸力，防止掉落 */
...
//#endif
	...
	/* 保护: 需要躲过刚启动、正反转切换的时候，另：履带电机堵转>=1.5A，正常工作电流0.5A */
